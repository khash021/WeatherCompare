...
public class ForecastFragment2 extends Fragment implements
        WeatherListFragmentAdapter.ListItemClickListener{

    private final static String TAG = ForecastFragment2.class.getSimpleName();

    private ArrayList<Weather> weatherArrayList;

    private Context context;

    public ForecastFragment2 (Context context, ArrayList<Weather> weatherArrayList) {
