...
public class ForecastFragment3 extends Fragment implements
        WeatherListFragmentAdapter.ListItemClickListener{

    private final static String TAG = ForecastFragment3.class.getSimpleName();

    private ArrayList<Weather> weatherArrayList;

    private Context context;

    public ForecastFragment3 (Context context, ArrayList<Weather> weatherArrayList) {
